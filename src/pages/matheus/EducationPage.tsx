...
import { CompetencyOverview } from "@/components/apos/CompetencyOverview";
import { getEducation, getCourses, getCertifications } from "@/data/adapters/localMockAdapter";
import { Search, X } from "lucide-react";

type Tab = "areas" | "formacao" | "cursos" | "certificacoes";
...
export default function Education() {
  ...
  const total = education.length + courses.length + certifications.length;
    ...
    <>
      ...
      <section className="container-wide pt-14 pb-10">
        <SectionHeader
          ...
          description="Trajetória documentada em quatro visões: por área de competência (todas as camadas juntas) ou separadamente por formação institucional, cursos e certificações."
        />
      </section>
      ...
      <section className="container-wide pb-6">
        <div className="flex gap-1 border-b border-border/70 overflow-x-auto">
          {([
            ["areas", "Por área de competência", total],
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <label className="relative flex-1 min-w-[220px] max-w-md">
                ...
                <input
                  ...
                  placeholder="Buscar em formação, cursos e certificações…"
              ...
              <div className="text-[11.5px] mono text-muted-foreground">
                {total} itens · agrupados por área
              </div>
            </div>
            <CompetencyOverview
              education={education}
